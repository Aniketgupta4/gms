        ...
        <div className="h-full flex flex-col p-6">
          ...
          <div className="mb-10 text-center">
            <h1 className="text-2xl font-black tracking-tighter text-white italic uppercase">
              {localStorage.getItem('gymName') || "GYMPRO"}
            </h1>
          ...
          <div className="bg-slate-800/50 p-4 rounded-2xl mb-10 flex items-center gap-4 border border-slate-700/50">
            <div className="w-14 h-14 rounded-xl overflow-hidden border-2 border-indigo-500 shadow-lg shadow-indigo-500/20 shrink-0">
              <img 
                alt="gym" 
            ...
            <div className="overflow-hidden">
              <p className="text-[10px] font-black uppercase tracking-widest text-indigo-400 leading-none mb-1">Admin</p>
              <h2 className="text-sm font-bold text-white truncate">{greeting}</h2>
            </div>
          </div>
