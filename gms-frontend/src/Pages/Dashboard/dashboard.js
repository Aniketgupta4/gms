...
const Dashboard = () => {
  ...
  return (
    /* 🔷 "flex-1" handles width, "lg:pl-0" removes extra gaps if layout is already flex */
    <div className="flex-1 min-h-screen bg-[#f8fafc] p-4 lg:p-8 relative overflow-y-auto">
      ...
      <header className="w-full bg-[#0f172a] shadow-2xl rounded-[2rem] mb-12 overflow-visible relative border border-slate-800">
        <div className="px-8 h-24 flex justify-between items-center">
          <div className="flex items-center gap-4">
            {/* Removed extra MenuIcon for cleaner look */}
      ...
      {/* 🔷 CARDS GRID - Refined borders to match theme */}
