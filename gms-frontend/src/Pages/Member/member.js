...
const Member = () => {
  ...
  return (
    /* 🛠️ LAYOUT FIX: Added lg:pl-72 and w-full to prevent overlap with fixed sidebar */
    <div className='flex-1 min-h-screen bg-[#f8fafc] lg:pl-72 w-full transition-all duration-300 relative overflow-x-hidden'>
      ...
      <div className='p-6 lg:p-10 w-full max-w-[1600px] mx-auto'>
        ...
        {/* 🔷 MEMBERS GRID */}
        <div className='bg-white/50 p-6 rounded-[3rem] border border-slate-100 min-h-[500px] w-full'>
           {data.length > 0 ? (
